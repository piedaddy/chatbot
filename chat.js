...
document.addEventListener('DOMContentLoaded', () => {
  ...
  for (const chat of conversation ) {
    if (chat.name === 'Unicorn') {
    chats.innerHTML += `<div class='remote'><div class="img__uni"> <img src="unicorn.png" width='60px';></div><div class="text__remote">${chat.text}</div></div>`
    }
    else if (chat.name === 'Cleverbot') {
      chats.innerHTML += `<div class='local'><div class="text__local">${chat.text}</div> <div class="img__bot"><img src="cleverbot.png" width='60px';></div></div>`;
    }
  }
